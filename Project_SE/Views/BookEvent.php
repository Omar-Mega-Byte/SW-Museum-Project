            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form method="post" action="../Controllers/BookEvent1.php" class="requires-validation" novalidate>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <select class="form-select mt-3" required>
                                    <option selected disabled value="">Event Type</option>
                                    <option value="jweb">Historic</option>
                                    <option value="sweb">Art</option>
                                    <option value="pmanager">Photgraph</option>
                                    <option value="pmanager">Science</option>
                                </select>
                                <div class="valid-feedback">You selected a position!</div>
                                <div class="invalid-feedback">Please select a position!</div>
                            </div>
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="eventname" placeholder="Event Name" required>
